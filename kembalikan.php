...
<head>
    ...
    <title>Berhasil Dikembalikan</title>
...
<div class="d-flex justify-content-center">
  ...
  <img src="img/blue-energy.jpg" class="card-img" alt=100% width="100" height="500">
  <div class="card-img-overlay"><br>
  <ul>
    <center>
    <h1>Selamat Anda berhasil Mengembalikan 
        Tools Anda</h1>
    <h2>Meminjamlah kembali dan jangan lupa amanah</h2>
    <h1>😊</h1>
    </center><br>

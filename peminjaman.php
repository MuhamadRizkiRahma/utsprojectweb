...
<div class="container">
  ...
  <div class="col-md-12">
    <ul><u>
    <h2> <center>Peminjaman Toolss</center></h2></u>
...
<div class="container">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="img/r3.jpg" class="d-block w-100" alt="100%">
                    </div>
                    <div class="carousel-item">
                      <img src="img/r1.jpeg" class="d-block w-100" alt="100%">
                    </div>
                    <div class="carousel-item">
                      <img src="img/r2.jpg" class="d-block w-100" alt="100%">
                    </div>
                  </div>
          ...
          <div class="col-md-7"><br>
              ...
              <i class="fa fa-star" aria-hidden="true"></i>
              <i class="fa fa-star" aria-hidden="true"></i>
              <i class="fa fa-star" aria-hidden="true"></i><p>1.324.000 Review</p>
          ...
          <div class="row pt-3">
              <div class="col-md-5">
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="img/s1.jpeg" class="d-block w-100" alt="100%">
                    </div>
                    <div class="carousel-item">
                      <img src="img/s2.jpeg" class="d-block w-100" alt="100%">
                    </div>
                    <div class="carousel-item">
                      <img src="img/s3.jpg" class="d-block w-100" alt="100%">
                    </div>
                  </div>
                 <button class="carousel-control-prev" type="button" data-target="#carouselExampleControls" data-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
          ...
          <div class="row pt-3">
              <div class="col-md-5">
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="img/b1.jpeg" class="d-block w-100" alt="100%">
                    </div>
                    <div class="carousel-item">
                      <img src="img/b2.jpeg" class="d-block w-100" alt="100%">
                    </div>
                    <div class="carousel-item">
                      <img src="img/b3.jpeg" class="d-block w-100" alt="100%">
                    </div>
                  </div>
                 <button class="carousel-control-prev" type="button" data-target="#carouselExampleControls" data-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
